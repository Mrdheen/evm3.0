...
const Navbar = () => {
  return (
    <div className="app-width fixed right-0 left-0 app-width top-6 z-50 w-full">
      <nav className="mx-auto bg-gray-600/30 backdrop-blur-lg p-4 rounded-3xl flex items-center justify-between shadow-lg z-50">
        {/* Logo */}
